...
export async function finishRental(req,res){ 
    ...
    try{
        ...
        const realReturnDate = (rentalData.rentDate.getTime())+(rentalData.daysRented*dayInMiliseconds);
        ...
        await db.query(`UPDATE rentals SET "returnDate"=$1 , "delayFee"=$2 WHERE id=$3`,[returnDateInUTC,delayFee,id])
        res.sendStatus(200)
    }catch(e){
        console.error(e)
        res.sendStatus(500)
